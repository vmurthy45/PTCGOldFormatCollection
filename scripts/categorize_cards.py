...
ENERGY_NAMES = {
    ...
    "Fire Energy", "Fusion Strike Energy", "Gift Energy", "Grass Energy",
    "Hiding Darkness Energy", "Jet Energy",
    ...
    "Ignition Energy", "Team Rocket's Energy", "Rocky Fighting Energy",
    "Telepathic Psychic Energy", "Enriching Energy", "Legacy Energy", "Boomerang Energy",
    "Mist Energy", "Counter Energy", "Super Boost Energy Prism Star",
    "Strong Energy", "Therapeutic Energy", "Triple Acceleration Energy", "Twin Energy",
    "Unit Energy FDF",
    "Unit Energy GRW", "Unit Energy LPM",
    "V Guard Energy", "Warp Energy", "Water Energy", "Weakness Guard Energy",
    "Wonder Energy",
}
...
TRAINER_NAMES = {
    ...
    "Battle VIP Pass", "Beast Bringer", "Beast Ring", "Bebe's Search", "Bellelba & Brycen-Man",
    "Bianca", "Bicycle", "Big Charm", "Bill's Analysis", "Bird Keeper", "Boss's Orders",
    "Box of Disaster",
    "Bravery Charm",
    ...
    "Cape of Toughness",
    "Capturing Aroma", "Chaotic Swell", "Cherish Ball", "Cheryl", "Choice Band", "Choice Belt",
    ...
    "Lana's Aid", "Sacred Ash", "Lucky Helmet", "Handheld Fan", "Nighttime Mine",
    "Gwynn",
    "Cyrano", "Black Belt's Training", "Ruffian", "Transformation Tome", "N's PP Up",
    ...
    "Great Ball", "Great Catcher", "Great Potion", "Green's Exploration", "Guzma", "Guzma & Hala",
    "Heat Factory Prism Star", "Heavy Ball", "Hex Maniac", "Hilda", "Hisuian Heavy Ball",
    "Hypnotoxic Laser", "Iono", "Irida", "Jamming Tower", "Judge", "Junk Arm",
    "Karate Belt", "Karen",
    ...
    "Roxanne", "Roxie", "Scoop Up Cyclone", "Scoop Up Net", "Scramble Switch", "Secret Box",
    "Shadow Triad", "Shauna", "Shrine of Punishment", "Silent Lab", "Sky Field",
    "Skyarrow Bridge", "Skyla", "Special Charge", "Spell Tag", "Spikemuth", "Stadium Nav",
    "Startling Megaphone", "Super Rod", "Super Scoop Up", "Superior Energy Retrieval",
    "Switch", "Switch Cart", "Tag Call", "Tag Switch", "Target Whistle", "Tate & Liza",
    ...
    "Team Rocket's Ariana", "Team Rocket's Archer", "Team Rocket's Factory",
    "Team Rocket's Giovanni", "Team Rocket's Petrel", "Team Rocket's Proton",
    "Team Rocket's Transceiver", "Poké Pad", "Roto-Stick", "Miracle Headset",
    "Teammates", "Technical Machine: Devolution",
