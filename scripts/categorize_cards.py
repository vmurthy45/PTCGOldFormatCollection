...
TRAINER_NAMES = {
    ...
    "Pokemon  Collector", "Pokemon Catcher", "Pokemon Collector", "Pokemon Communication",
    "Pokemon Rescue", "PokéStop", "Pokégear 3.0", "Pokémon Catcher", "Pokémon Center Lady",
    "Pokémon Communication", "Pokémon Fan Club", "Pokémon Ranger", "Pok√©mon Catcher",
